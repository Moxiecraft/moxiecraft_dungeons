...
$data modify storage moxiecraft_dungeons:registry dungeons.$(dungeon).enter set value "moxiecraft_dungeons:api/hook/nohook"
$data modify storage moxiecraft_dungeons:registry dungeons.$(dungeon).exit set value "moxiecraft_dungeons:api/hook/nohook"
$data modify storage moxiecraft_dungeons:registry dungeons.$(dungeon).tick set value "moxiecraft_dungeons:api/hook/nohook"
